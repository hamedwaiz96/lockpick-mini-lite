...
/* harmony import */ var _lockpick__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lockpick */ "./lockpick.js");
...
var Game = /*#__PURE__*/function () {
  function Game() {
    ...
    var self = this;
    this.lockpick = new _lockpick__WEBPACK_IMPORTED_MODULE_0__["default"](this);
    this.lockpicks = 100;
    this.money = 0;
    this.justReceived = 0;
  ...
  _createClass(Game, [{
    ...
    key: "addRandomMoney",
    value: function addRandomMoney() {
      this.justReceived = this.generateWeightedRandomNumber();
      this.money += this.justReceived;
    }
  }, {
    key: "generateWeightedRandomNumber",
    value: function generateWeightedRandomNumber() {
      var finalNum;

      for (var i = 0; i <= DIFFICULTY_MONEY_MAP[this.lockpick.difficulty] - 1; i++) {
    ...
    value: function updateUI() {
      ...
      var difficultyCon = document.getElementsByClassName('difficulty')[0];
      var lockpickNum = document.getElementsByClassName('lockpicks-num')[0];
      var moneyNum = document.getElementsByClassName('money-num')[0];
      var receivedNum = document.getElementsByClassName('received-num')[0];
      lockpickNum.innerHTML = this.lockpicks;
      moneyNum.innerHTML = this.money;
      difficultyCon.innerHTML = this.lockpick.difficulty;

      if (initial) {
        receivedNum.innerHTML = "received ".concat(this.justReceived, " gold!");
    ...
    key: "handleEventUp",
    value: function handleEventUp(e) {
      if (e.code == "ArrowUp") {
        e.preventDefault();
        this.lockpick.letGo();
...
var Lockpick = /*#__PURE__*/function () {
  function Lockpick(game) {
    var difficulty = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Novice";

    _classCallCheck(this, Lockpick);
  ...
  _createClass(Lockpick, [{
    ...
    value: function turnRight() {
      ...
      if (this.rightTimeout !== "") {
        window.clearInterval(this.rightTimeout);
      }

      this.rightTimeout = window.setInterval(function () {
        if (_this.checkValidMove("right")) {
          _this.currentPos += 1;

          _this.populateCanvas();
        } else {
          window.clearInterval(_this.rightTimeout);
        }
      }, 10);
    }
  }, {
    ...
    value: function turnLeft() {
      ...
      this.leftTimeout = window.setInterval(function () {
        if (_this2.checkValidMove("left")) {
          _this2.currentPos -= 1;

          _this2.populateCanvas();
        } else {
          window.clearInterval(_this2.leftTimeout);
        }
      }, 10);
    }
  }, {
    key: "tryUnlock",
    value: function tryUnlock() {
      var _this3 = this;
      ...
      this.upTimeout = window.setInterval(function () {
        if (_this3.currentUnlockStatus < _this3.findUnlockStatus()) {
          _this3.currentUnlockStatus += 1;
        } else if (_this3.currentUnlockStatus === _this3.findUnlockStatus()) {
          if (_this3.checkIfWon()) {
            window.clearInterval(_this3.upTimeout);
            console.log("Winner!");
        ...
        _this3.populateCanvas();
      }, 8);
    }
  }, {
    key: "letGo",
    value: function letGo() {
      var _this4 = this;
      ...
      this.downTimeout = window.setInterval(function () {
        if (_this4.currentUnlockStatus === 0) {
          window.clearInterval(_this4.downTimeout);
        }

        _this4.currentUnlockStatus -= 1;

        _this4.populateCanvas();
      }, 8);
    }
  }, {
    key: "checkInDeterminingSector",
    value: function checkInDeterminingSector() {
      return this.currentPos >= this.determiningSectorRange[0] && this.currentPos <= this.determiningSectorRange[1];
    }
  }, {
    key: "checkInWinningSector",
    value: function checkInWinningSector() {
      return this.currentPos >= this.winningSectorRange[0] && this.currentPos <= this.winningSectorRange[1];
    }
  }, {
    key: "findUnlockStatus",
    value: function findUnlockStatus() {
      if (this.checkInWinningSector()) {
        return 180;
      } else if (this.checkInDeterminingSector()) {
        var firstHalf = [this.determiningSectorRange[0], this.winningSectorRange[0]];
        var secondHalf = [this.winningSectorRange[1], this.determiningSectorRange[1]];
    ...
    key: "checkValidMove",
    value: function checkValidMove(dir) {
      var change = dir === "left" ? -1 : 1;

      if (this.currentPos + change > 180 || this.currentPos + change < 0) {
        return false;
      }
    ...
    key: "chooseWinningSectorRange",
    value: function chooseWinningSectorRange() {
      var startSector = Lockpick.randomInteger(this.sectorAngle, 180 - this.sectorAngle);
      var dir = Lockpick.randomInteger(0, 1);
    ...
    key: "convertAngleToX",
    value: function convertAngleToX(angle) {
      return Math.sin(-(angle + 90) * (Math.PI / 180)) * this.radius + this.canvasXDiff;
    }
  }, {
    key: "convertAngleToY",
    value: function convertAngleToY(angle) {
...
/* harmony default export */ __webpack_exports__["default"] = (Lockpick);
